...
const AUTH_SERVICE                     = (process.env.AUTH_SERVICE)? utils.slugify(process.env.AUTH_SERVICE):pjson.name;


const USER_PORT                        = process.env.USER_PORT || 5111;
const ADMIN_PORT                       = process.env.ADMIN_PORT || 5222;
const AUTH_PORT                       = process.env.AUTH_PORT || 5223;


const ADMIN_URL                        = process.env.ADMIN_URL || `http://localhost:${ADMIN_PORT}`;
const ENV                              = process.env.ENV || "development";
const REDIS_URI                        = process.env.CACHE_REDIS || "redis://127.0.0.1:6379";
